(() => {
  ...
  async function protectedStop() {
    try {
      ...
      if (typeof stopCamera === 'function' && stream) {
        // stable.start toggles the existing camera off using the protected lock.
        await stable.start();
      }
    } finally {
